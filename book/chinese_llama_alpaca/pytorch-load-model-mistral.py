...
# model2 = AutoModelForCausalLM.from_pretrained("elinas/llama-7b-hf-transformers-4.29")
# tokenizer2 = AutoTokenizer.from_pretrained("elinas/llama-7b-hf-transformers-4.29")
